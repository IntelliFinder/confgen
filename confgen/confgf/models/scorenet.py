...
class EquiDistanceScoreMatch(torch.nn.Module):
    ...
    def extend_graph(self, data: Data, order=3):
        ...
        #TODO: go data by data and perform these operatrions:
    ...
    def get_score(self, data: Data, d, sigma):
        ...
        #dge_embed = self.project(edge_embed)
    ...
    def forward(self, data):
        ...
        Output:
            loss
        """
        print("entered forward in scorenet")
        ...
        print("entering extend graph")
        data = self.extend_graph(data, self.order)
        print("reached right after extend graph")
