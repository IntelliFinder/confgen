...
class GradientGEGNNWL(torch.nn.Module):
    ...
    def __init__(self, hidden_dim, hidden_coff_dim=64, num_convs=3, activation="softplus", readout="sum", short_cut=False, concat_hidden=False, color_steps=1):
        ...
        config_path = "/home/snirhordan/ClofNet/confgen/confgf/layers/DisGNN/config/{}_{}.yaml".format(model_name, dataset_name) #TODO ERASE NAMES!
    ...
    def forward(self, data, node_attr, edge_attr):
        ...
        Output:
            ...
            graph feature
        """
        print("entered forward in equiwl")
        #get wl edge features
        wl_edge_feat = self.model(data)
        print("WL successful !")
